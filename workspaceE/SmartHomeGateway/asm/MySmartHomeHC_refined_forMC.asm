...
asm MySmartHomeHC_refined_forMC
...
definitions:
	...
	//LTLSPEC g(windows_Setting(hs_gf) = OPEN implies not(heatingsON))
	LTLSPEC g((heatingsON and windowsStatusSaved(int_hc_gf) = OPEN) implies f(windows_Setting(hs_gf) = CLOSED))
	//LTLSPEC g(windows_Setting(hs_ff) = OPEN implies not(heatingsON))
	LTLSPEC g((heatingsON and windowsStatusSaved(int_hc_ff) = OPEN) implies f(windows_Setting(hs_ff) = CLOSED))
