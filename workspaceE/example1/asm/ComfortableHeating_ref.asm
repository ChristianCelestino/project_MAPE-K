...
//Adaptation goal: (i) when it is cold, the heatings should be at sufficient settings for comfort"
//
...
signature:
	...
	controlled loopCompleted: IntTempMgA -> Boolean
	derived allSubloopsCompleted: Boolean
...
definitions:
	...
	function allSubloopsCompleted = (forall $a in IntTempMgA with loopCompleted($a))	
...
default init s0:
	...
	function loopCompleted ($a in IntTempMgA) = true
